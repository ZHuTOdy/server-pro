package cn.iocoder.basic.framework.web.config;
...
import cn.iocoder.basic.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.basic.framework.web.core.filter.DemoFilter;
import cn.iocoder.basic.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.basic.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class BasicWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "basic.demo", havingValue = "true")
