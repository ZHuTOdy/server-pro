package cn.iocoder.basic.framework.tracer.config;

import cn.iocoder.basic.framework.common.enums.WebFilterOrderEnum;
import cn.iocoder.basic.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "basic.tracer", value = "enable", matchIfMissing = true)
public class BasicTracerAutoConfiguration {
