package cn.iocoder.basic.module.pay.service.order;
...
import cn.iocoder.basic.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import cn.iocoder.basic.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import cn.iocoder.basic.module.pay.convert.order.PayOrderConvert;
...
import cn.iocoder.basic.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import cn.iocoder.basic.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import cn.iocoder.basic.module.pay.dal.mysql.order.PayOrderMapper;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/basic-cloud/issues/I8SM9H 场景
