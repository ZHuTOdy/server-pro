package cn.iocoder.basic.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.iocoder.basic.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
