package cn.iocoder.basic.module.system.service.user;
...
import cn.iocoder.basic.framework.common.util.collection.ArrayUtils;
...
import cn.iocoder.basic.module.infra.api.config.ConfigApi;
import cn.iocoder.basic.module.infra.api.file.FileApi;
import cn.iocoder.basic.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.iocoder.basic.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.iocoder.basic.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.iocoder.basic.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.iocoder.basic.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.iocoder.basic.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import static cn.iocoder.basic.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("basicyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("basicyuanma");
        ...
        assertEquals("basicyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("basicyuanma"))).thenReturn("java");
