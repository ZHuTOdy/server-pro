package cn.iocoder.basic.module.member.controller.admin.config;

import cn.iocoder.basic.framework.common.pojo.CommonResult;
import cn.iocoder.basic.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.iocoder.basic.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.iocoder.basic.module.member.convert.config.MemberConfigConvert;
import cn.iocoder.basic.module.member.dal.dataobject.config.MemberConfigDO;
import cn.iocoder.basic.module.member.service.config.MemberConfigService;
