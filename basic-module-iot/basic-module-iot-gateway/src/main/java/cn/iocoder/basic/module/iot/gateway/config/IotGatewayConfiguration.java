package cn.iocoder.basic.module.iot.gateway.config;

import cn.iocoder.basic.module.iot.core.messagebus.core.IotMessageBus;
import cn.iocoder.basic.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import cn.iocoder.basic.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import cn.iocoder.basic.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import cn.iocoder.basic.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import cn.iocoder.basic.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import cn.iocoder.basic.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import cn.iocoder.basic.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import cn.iocoder.basic.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import cn.iocoder.basic.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import cn.iocoder.basic.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import cn.iocoder.basic.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import cn.iocoder.basic.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import cn.iocoder.basic.module.iot.gateway.service.device.IotDeviceService;
import cn.iocoder.basic.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "basic.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "basic.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "basic.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "basic.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
