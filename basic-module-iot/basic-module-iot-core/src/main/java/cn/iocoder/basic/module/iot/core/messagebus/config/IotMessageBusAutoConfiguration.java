package cn.iocoder.basic.module.iot.core.messagebus.config;

import cn.iocoder.basic.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.basic.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.iocoder.basic.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.iocoder.basic.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.iocoder.basic.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.iocoder.basic.module.iot.core.messagebus.core.IotMessageBus;
import cn.iocoder.basic.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.iocoder.basic.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.iocoder.basic.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "basic.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "basic.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 BasicRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.iocoder.basic.framework.mq.redis.config.BasicRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "basic.iot.message-bus", name = "type", havingValue = "redis")
