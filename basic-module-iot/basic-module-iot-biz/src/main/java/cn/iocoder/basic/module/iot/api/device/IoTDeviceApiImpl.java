package cn.iocoder.basic.module.iot.api.device;

import cn.iocoder.basic.framework.common.enums.RpcConstants;
...
import cn.iocoder.basic.module.iot.core.biz.dto.IotDeviceGetReqDTO;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 basic-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
