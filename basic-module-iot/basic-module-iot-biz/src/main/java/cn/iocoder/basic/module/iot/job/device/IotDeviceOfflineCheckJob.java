package cn.iocoder.basic.module.iot.job.device;
...
import cn.iocoder.basic.module.iot.framework.iot.config.BasicIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private BasicIotProperties iotProperties;
