package cn.iocoder.basic.module.trade.convert.order;
...
import cn.iocoder.basic.framework.common.util.string.StrUtils;
import cn.iocoder.basic.framework.dict.core.DictFrameworkUtils;
import cn.iocoder.basic.framework.ip.core.utils.AreaUtils;
import cn.iocoder.basic.module.member.api.address.dto.MemberAddressRespDTO;
import cn.iocoder.basic.module.member.api.user.dto.MemberUserRespDTO;
import cn.iocoder.basic.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.iocoder.basic.module.pay.enums.DictTypeConstants;
import cn.iocoder.basic.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.iocoder.basic.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.iocoder.basic.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.iocoder.basic.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.iocoder.basic.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.iocoder.basic.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.iocoder.basic.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.iocoder.basic.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.iocoder.basic.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.iocoder.basic.module.trade.controller.admin.order.vo.*;
import cn.iocoder.basic.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.iocoder.basic.module.trade.controller.app.order.vo.*;
import cn.iocoder.basic.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.iocoder.basic.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.iocoder.basic.module.trade.dal.dataobject.order.TradeOrderLogDO;
import cn.iocoder.basic.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.iocoder.basic.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.iocoder.basic.module.trade.framework.order.config.TradeOrderProperties;
import cn.iocoder.basic.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.iocoder.basic.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.iocoder.basic.framework.common.util.collection.CollectionUtils.convertMultiMap;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/basiccode/basic-mall-uniapp/issues/ICY7SJ
