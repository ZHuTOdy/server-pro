package cn.iocoder.basic.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 cn.iocoder.basic.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
