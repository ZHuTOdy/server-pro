package cn.iocoder.basic.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.iocoder.basic.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
