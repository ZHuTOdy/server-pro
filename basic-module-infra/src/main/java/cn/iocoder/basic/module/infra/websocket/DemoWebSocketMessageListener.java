package cn.iocoder.basic.module.infra.websocket;
...
import cn.iocoder.basic.framework.websocket.core.sender.WebSocketMessageSender;
import cn.iocoder.basic.framework.websocket.core.util.WebSocketFrameworkUtils;
import cn.iocoder.basic.module.infra.websocket.message.DemoReceiveMessage;
import cn.iocoder.basic.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 basic.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
