package cn.iocoder.basic.module.ai.framework.ai.core.model;
...
import cn.iocoder.basic.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.iocoder.basic.module.ai.framework.ai.config.BasicAiProperties;
...
import cn.iocoder.basic.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.iocoder.basic.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            BasicAiProperties.Midjourney properties = SpringUtil.getBean(BasicAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(BasicAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        BasicAiProperties.DouBao properties = new BasicAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(BasicAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        BasicAiProperties.HunYuan properties = new BasicAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(BasicAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        BasicAiProperties.SiliconFlow properties = new BasicAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(BasicAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        BasicAiProperties.XingHuo properties = new BasicAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(BasicAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        BasicAiProperties.BaiChuan properties = new BasicAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(BasicAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        BasicAiProperties.Gemini properties = SpringUtil.getBean(BasicAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        BasicAiProperties.Grok properties = new BasicAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
