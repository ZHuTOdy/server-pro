package cn.iocoder.basic.module.ai.service.chat;
...
import cn.iocoder.basic.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.iocoder.basic.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.iocoder.basic.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.iocoder.basic.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.iocoder.basic.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.iocoder.basic.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.iocoder.basic.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.iocoder.basic.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.iocoder.basic.module.ai.dal.dataobject.model.AiModelDO;
import cn.iocoder.basic.module.ai.dal.dataobject.model.AiToolDO;
import cn.iocoder.basic.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.iocoder.basic.module.ai.enums.ErrorCodeConstants;
...
import cn.iocoder.basic.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.iocoder.basic.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.iocoder.basic.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.iocoder.basic.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.iocoder.basic.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.iocoder.basic.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.iocoder.basic.module.ai.service.model.AiChatRoleService;
import cn.iocoder.basic.module.ai.service.model.AiModelService;
import cn.iocoder.basic.module.ai.service.model.AiToolService;
import cn.iocoder.basic.module.ai.util.AiUtils;
import cn.iocoder.basic.module.ai.util.FileTypeUtils;
...
import static cn.iocoder.basic.framework.common.pojo.CommonResult.error;
import static cn.iocoder.basic.framework.common.pojo.CommonResult.success;
import static cn.iocoder.basic.framework.common.util.collection.CollectionUtils.convertList;
import static cn.iocoder.basic.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.iocoder.basic.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.iocoder.basic.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 basic.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 basic.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
